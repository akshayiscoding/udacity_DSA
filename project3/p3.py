...
print(rearrange_digits([4, 7, 2, 5, 9, 8]))  # [964, 852]]
print(rearrange_digits([2, 1]))  # [2, 1]
print(rearrange_digits([41]))  # [42]
print(rearrange_digits(None))  # None
print(rearrange_digits([2, 1, 9, 7, 8]))  # [971, 82]
print(rearrange_digits([8, 7, 2, 4, 2, 1]))  # [862, 741]
        ...
        for num in input_list:
            if num == digit:
                if flag == 1:
                    ...
                    # change digit place (for ex, tens to hundreds)
